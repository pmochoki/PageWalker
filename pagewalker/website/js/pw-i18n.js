(function () {
  ...
  var privacyEn = [
    ...
    "Not directed at children under 13. Contact support@pagewalker.org if you believe a child under 13 created an account.",
    "",
    "8. YOUR RIGHTS AND CHOICES",
    "Access, correct, delete your account from Profile Settings; export data by emailing support@pagewalker.org (response within 30 days); control public/private profile; opt out of notifications; withdraw consent by deleting your account.",
    "",
    "9. THIRD PARTY LINKS",
    ...
    "",
    "11. CONTACT US",
    "Email: support@pagewalker.org — App: Pagewalker — We respond within 30 days. For urgent data deletion, include \"URGENT DATA DELETION\" in the subject line (response within 7 days).",
    "",
  ...
  var privacyHu = [
    ...
    "Nem 13 év alatti gyermekeknek szánt. Írj nekünk a support@pagewalker.org címre, ha úgy véled, 13 év alatti gyermek hozott létre fiókot.",
    "",
    "8. JOGAID ÉS LEHETŐSÉGEID",
    "A Profil beállításokban hozzáférhetsz, módosíthatod vagy törölheted a fiókodat; az adataid exportálásához írj a support@pagewalker.org címre (30 napon belül válaszolunk); választhatsz a nyilvános/privát profil között; letilthatod az értesítéseket; a fiók törlésével visszavonhatod a hozzájárulásodat.",
    "",
    ...
    "",
    "11. KAPCSOLAT",
    "E-mail: support@pagewalker.org — App: Pagewalker — 30 napon belül válaszolunk. Sürgős adattörléshez írd a tárgysorba: \"URGENT DATA DELETION\" (7 napon belül válaszolunk).",
    "",
  ...
  var termsEn = [
    ...
    "5.4 If you believe any content on Pagewalker infringes your copyright, please contact us at support@pagewalker.org with details of the infringement.",
    "",
    "6. BOOK CLUB ROOMS",
  ...
  var termsHu = [
    ...
    "5.4 Ha úgy érzed, hogy a Pagewalker tartalma sérti a szerzői jogodat, jelezd nekünk a support@pagewalker.org címen a jogsértés részleteivel.",
    "",
    "6. KÖNYVKLUB SZOBÁK",
  ...
  var DICT = {
    en: {
      ...
      "common.supportEmail": "support@pagewalker.org",
      ...
      "drawer.desc.discover": "Search, explore moods, trending, genres & classics",
      "drawer.discover.overview": "Overview",
      "drawer.discover.trending": "Trending",
      "drawer.discover.genre": "Genre exploration",
      "drawer.discover.classics": "Classics",
      "drawer.discover.chevronTitle": "Show or hide sections",
      "drawer.discover.search": "Search & mood",
      ...
      "route.discover.heading": "Discover",
      "route.discover.body": "Browse catalog books and use app search from web.",
      "route.discover.hubLabel": "Discover overview",
      "route.discover.hubSubtitle": "Search, explore moods, trending books, genres, and free classics",
      "route.discover.hubCardSearch": "Search the catalog and find reads by mood.",
      "route.discover.hubCardTrending": "See what’s hot right now.",
      "route.discover.hubCardGenre": "Browse books by genre.",
      "route.discover.hubCardClassics": "Explore free classic literature.",
      "route.discover.overview": "Overview",
      "route.discover.tabstripLabel": "Discover areas",
      "route.discover.sectionsLabel": "Discover content",
      ...
      "route.discover.searchResultsTitle": "Title search results",
      "route.discover.searchEmpty": "No matches. Try different words.",
      ...
      "route.book.reviewHere": "Write your review",
      "route.book.reviewText": "Your review",
      "route.book.reviewPlaceholder": "What did you think?",
      "route.book.postReview": "Post review",
      "route.book.reviewVisibleHint": "Your review appears in the list below for this book.",
      "route.book.about": "About this book",
      "route.book.noDescription": "No description yet.",
      "route.book.reviewsForBook": "Reviews for this book",
      "route.book.noReviewsYet": "No reviews yet. Be the first to add one above.",
      "route.book.reviewTextRequired": "Write something for your review.",
      ...
      "route.social.feedIntro":
        "Below you’ll see reviews from the community (newest first). On each book’s page you can post a review for that title and see what others wrote. Discover is for trending books and search; Home has a short “Reader buzz” preview.",
      ...
      "route.clubs.chatTitle": "Group chat",
      "route.clubs.chatHint": "Everyone in the club can read and post here. New messages appear at the bottom—scroll up for older ones.",
      "route.clubs.chatEmpty": "No messages yet. Say hi below—others will see it here, like a group chat.",
      "route.clubs.chatYou": "You",
      "route.clubs.chatPlaceholder": "Message the group…",
      "route.clubs.send": "Send",
      "route.clubs.chatOptions": "Chapter & spoiler",
    ...
    hu: {
      ...
      "drawer.desc.discover": "Keresés, hangulat, trend, műfajok és klasszikusok",
      "drawer.discover.overview": "Áttekintés",
      "drawer.discover.trending": "Trendi",
      "drawer.discover.genre": "Műfaj felfedezés",
      "drawer.discover.classics": "Klasszikusok",
      "drawer.discover.chevronTitle": "Szekciók megjelenítése vagy elrejtése",
      "drawer.discover.search": "Keresés és hangulat",
      ...
      "signup.forgotPassword": "Elfelejtetted a jelszót?",
      "auth.or": "vagy",
      ...
      "route.discover.heading": "Felfedezés",
      "route.discover.body": "Böngéssz a katalógusban és keress weben.",
      "route.discover.hubLabel": "Felfedezés áttekintés",
      "route.discover.hubSubtitle": "Keresés, hangulat, trend, műfajok és klasszikusok",
      "route.discover.hubCardSearch": "Keresés a katalógusban és olvasmányok hangulat alapján.",
      "route.discover.hubCardTrending": "Nézd meg, mi a legnépszerűbb most.",
      "route.discover.hubCardGenre": "Böngéssz műfaj szerint.",
      "route.discover.hubCardClassics": "Ingyenes klasszikus irodalom.",
      "route.discover.overview": "Áttekintés",
      "route.discover.tabstripLabel": "Felfedezés szekciók",
      "route.discover.sectionsLabel": "Felfedezés tartalom",
      ...
      "route.discover.searchResultsTitle": "Címkeresés találatai",
      "route.discover.searchEmpty": "Nincs találat. Próbálj más szavakat.",
      ...
      "route.book.reviewHere": "Írd meg az értékelésed",
      "route.book.reviewText": "Értékelésed",
      "route.book.reviewPlaceholder": "Mi a véleményed?",
      "route.book.postReview": "Értékelés közzététele",
      "route.book.reviewVisibleHint": "Az értékelésed az alábbi listában jelenik meg ehhez a könyvhöz.",
      "route.book.about": "A könyvről",
      "route.book.noDescription": "Még nincs leírás.",
      "route.book.reviewsForBook": "Értékelések ehhez a könyvhöz",
      "route.book.noReviewsYet": "Még nincs értékelés. Legyél az első – fent írhatsz egyet.",
      "route.book.reviewTextRequired": "Írj valamit az értékelésbe.",
      ...
      "route.social.feedIntro":
        "Itt a közösség értelmezései jelennek meg (a legfrissebb felül). Minden könyv adatlapján megírhatod és elolvashatod az adott címhez szóló értékeléseket. A Felfedezésnél trendi könyveket találsz; a kezdőlapról a „Reader buzz” rövid előnézete jó.",
      ...
      "route.clubs.chatTitle": "Csoportos csevegés",
      "route.clubs.chatHint": "A klub minden tagja olvashatja és írhatja. Az új üzenetek lent—görgess fel a régi üzenetekért.",
      "route.clubs.chatEmpty": "Még nincs üzenet. Ide lent írd az elsőt—a többiek itt látják, mint egy csoportban.",
      "route.clubs.chatYou": "Te",
      "route.clubs.chatPlaceholder": "Üzenet a csoportnak…",
      "route.clubs.send": "Küldés",
      "route.clubs.chatOptions": "Fejezet és spoiler",
